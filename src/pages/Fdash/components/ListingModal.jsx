...
//   isLoading,
//   error,
//   // editingListing, // Optional flag for editing an existing listing
// }) => {
...
//               onChange={(e) => setFormData({ ...formData, croppingtime: e.target.value })}
//               className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
//               placeholder="Enter cropping time"
//             />
//           </div>
...
//               onChange={(e) => setFormData({ ...formData, harvestingtime: e.target.value })}
//               className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
//               placeholder="Enter harvesting time"
//             />
//           </div>
...
//               className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
//             >
//               <option value="">{!formData.fstate ? 'Select a state first' : 'Select City'}</option>
...
//               onChange={(e) => setFormData({ ...formData, fpincode: e.target.value })}
//               className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
