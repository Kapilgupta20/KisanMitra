                    ...
                    <div key={index} className={`flex gap-4 ${entry.sender === "buyer" ? "flex-row-reverse" : ""}`}>
                      <div
                        className={`flex-1 p-4 rounded-lg ${
                          entry.sender === "buyer" ? "bg-green-50 text-green-900" : "bg-gray-50 text-gray-900"
                        }`}
                      >
                        <div className="flex items-center justify-between mb-2">
                          <span className="font-medium">{entry.sender === "buyer" ? "Your Offer" : "Farmer's Offer"}</span>
                ...
                <div className="p-6">
                  ...
                  <form onSubmit={handleSubmitCounter} className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <button
                        type="submit"
                        className="bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 cursor-pointer"
                      >
