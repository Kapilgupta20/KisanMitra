...
//                     className="ml-3 text-gray-400 hover:text-green-600 transition-colors"
//                     aria-label="Add to favourites"
//                 >
//                     <HeartIcon
//                         className={`h-5 w-5 ${favourited ? 'fill-green-500 text-green-500' : 'fill-none'}`}
//                     />
//                 </button>
//             </div>
//         </div>
