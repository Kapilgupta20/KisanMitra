              ...
              {contracts.map((contract) => (
                <button
                  ...
                  className={`w-full p-4 text-left hover:bg-gray-50 transition-colors cursor-pointer ${
                    selectedContract?._id === contract._id ? "bg-gray-50" : ""
                  }`}
                >
              ...
              <div className="p-6 border-b">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      className="flex gap-2 px-4 py-2 rounded-lg cursor-pointer bg-gray-50"
                      onClick={() => getContract(selectedContract._id)}
                    >
                      <Download />
                    </button>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium text-gray-900">
                      {new Date(selectedContract.startDate).toISOString().split("T")[0]}
                    </span>
                  </div>
                  <div>
